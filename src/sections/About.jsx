    ...
    return (
        <section id="about">
            ...
            <div className="ab-grid">
                ...
                <div>
                    <p className="ab-text">
                        Hey!, I'm Harshvardhan Kadam - a Software Engineer and Full Stack Developer working with data systems for 100+ airlines. I specialize in building scalable applications using NODE JS, EXPRESS JS, MS SQL, REACT JS and solving real-world problems using clean, efficient architecture.

                        I enjoy working across the stack — from crafting intuitive frontends to designing robust backend systems — always focusing on performance, usability, and business impact.
                    </p>
                    <p className="ab-text" style={{ marginTop: "0.7rem" }}>
                        Currently building impactful software at{" "}
                        <strong style={{ color: "var(--c1)" }}>Accelya Solutions Ind. Ltd.</strong>. I'm driven
                        by clean architecture, developer experience, and shipping software that actually
                        matters. When I'm not coding, I'm exploring DevOps tooling, Exploring cloud tools or deep-diving into system design.
                    </p>
